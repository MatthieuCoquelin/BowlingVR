...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected void GrabEnd()
    {
        if (m_grabbedObj != null)
        {
            ...
            Vector3 linearVelocity = trackingSpace.orientation * OVRInput.GetLocalControllerVelocity(m_controller) * 2;
            Vector3 angularVelocity = trackingSpace.orientation * OVRInput.GetLocalControllerAngularVelocity(m_controller) * 2;
